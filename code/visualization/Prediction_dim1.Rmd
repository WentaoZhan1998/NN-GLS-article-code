...
```{r}
ggsave('RMSE_dim1_fix_main.png', width = 8, height = 6)
```
...
```{r}
ggsave('RMSE_dim1.png', width = 8, height = 6)
```
...
```
```{r}
ggsave('RMSE_dim1_matern.png', width = 8, height = 6)
```
...
```{r}
ggsave('RMSE_dim1_fix.png', width = 8, height = 6)
```